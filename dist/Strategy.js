...
exports.buildOptions = function (options) {
    var query = querystring_1.default.stringify(__assign(__assign(__assign({}, (options.prompt && { prompt: options.prompt })), (options.state && { state: options.state })), (options.nonce && { nonce: options.nonce })));
